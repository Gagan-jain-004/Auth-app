...
const sendVerificationOtp = async ()=>{
  try{
    ...
    const {data} = await axios.post(backendUrl + '/api/auth/send-verify-otp')     //  call to backend for otp 

    if(data.success){               //agr otp aati toh yeh true aur navigate to below frontend page 
 ...
 return (
     <div className='w-full flex justify-between p-4 sm:p-6 sm:px-24 absolute top-0'>
       <img src={assets.logo} alt="del" className='w-28 sm:w-32' />
       {
        userData ?
