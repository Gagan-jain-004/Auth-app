     ...
     const handleKeyDown = (e,index)=>{
       ...
       const onSubmitNewPassword = async (e) =>{
        ...
        try{
         ...
         await data.success ? toast.success(data.message) : toast.error(data.message)
...
{ !isOtpSubmited && isEmailSent &&
      ...
      <h1 className='text-white text-2xl font-semibold text-center mb-4'>Recent password OTP</h1>
