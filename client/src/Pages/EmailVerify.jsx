...
const EmailVerify = () => {
  ...
  axios.defaults.withCredentials = true          // for cookie store 
...
const onSubmitHandler = async (e)=>{
  try{
    ...
    const {data} = await axios.post(backendUrl + '/api/auth/verify-account',{otp})   // so user input otp is api pe gayi for checking 
    if(data.success){
